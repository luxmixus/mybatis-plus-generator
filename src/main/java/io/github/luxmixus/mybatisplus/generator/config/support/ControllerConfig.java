...
import io.github.luxmixus.mybatisplus.generator.config.po.ClassPayload;
...
//                importPackages.add("io.swagger.annotations.ApiParam");
        ...
        if (globalConfig.isGenerateQuery()) {
            ...
            if (globalConfig.isEnhancer()){
                ...
                importPackages.add("io.github.luxmixus.mybatisplus.enhancer.query.helper.SqlHelper");
            }
    ...
    public static class Adapter {
        ...
        public <R> Adapter returnMethod(com.baomidou.mybatisplus.core.toolkit.support.SFunction<Object, R> methodReference) {
            this.config.returnMethod = io.github.luxmixus.mybatisplus.generator.util.ReflectUtil.lambdaMethodInfo(methodReference, Object.class);
            return this;
        }
        ...
        public <O, R> Adapter pageMethod(com.baomidou.mybatisplus.core.toolkit.support.SFunction<com.baomidou.mybatisplus.core.metadata.IPage<O>, R> methodReference) {
            this.config.pageMethod = io.github.luxmixus.mybatisplus.generator.util.ReflectUtil.lambdaMethodInfo(methodReference, com.baomidou.mybatisplus.core.metadata.IPage.class);
            return this;
        }
...
//            this.config.queryParam = new io.github.luxmixus.mybatisplus.generator.config.po.ClassPayload(queryDTO);
            return this;
        }
    }
}